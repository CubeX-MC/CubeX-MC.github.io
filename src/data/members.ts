...
export const adminTimeline: string[] = [
  'SiYang + angushushu',
  'SiYang + angushushu + AkariDream',
  'angushushu + AkariDream',
  'AkariDream + XY_Kuailexy',
  'angushushu',
  'angushushu + wwwer',
  'angushushu + wwwer + AkariDream',
  'angushushu + wwwer + SiYang',
  'SiYang',
  'AdlambXD + Mark_Q',
  'xingchen',
  'AdlambXD + Mark_Q',
...
export const adminTimelineSecret: string[] = [
  'Commune 社区 — 两个追求权力的人在别人的社区里做着"我要掌管一切"的美梦。天真得令人心疼。',
  'CubeX 开服 — 拉来三个冤大头，几人正式开始了一场"谁先跑谁是小狗"的囚徒困境。',
  '首次裂痕 — SiYang 和 angushushu 吵翻了。意料之中——两个创始人不翻脸的服务器还没出生过。',
  '第一次交接 — angushushu "退休"了，AkariDream 推了个傀儡上位，自己垂帘听政。可惜扶持的狗腿子 xmzh 封人封到自己人都受不了，服务器当场暴毙。',
  '回归与决裂 — 眼看服务器要凉，angushushu 光速"复出"，跟 AkariDream 撕破脸。"退休"这事儿就像减肥，说起来容易。',
  '小湖镇复兴 — angushushu 在一堆废墟里发现了一个叫 wwwer 的老实人，二话不说提拔成 OP。至于 wwwer 后来有没有后悔，只有他自己知道。',
  '短暂重聚 — AkariDream："我也想回来玩。" angushushu："行吧。" 翻译：我想再试一次夺权。行吧但我不让。',
  '故人归来 — SiYang 回来了。三巨头共治！历史上三巨头共治的下场通常是一个被流放，一个被暗杀，一个独吞。',
  '半退休时代 — angushushu 和 wwwer "半退休"，翻译：退居幕后继续操控。开了个测试服，美其名曰"技术探索"，实为下一盘大棋。SiYang 前台撑场面，压根不知道自己是傀儡。',
  '预备交接 — SiYang 终于也退了。AdlambXD 和 Mark_Q 作为预备服主登场——两个等着接盘的接盘侠。',
  '二周目开启 — angushushu 等人"正式退休"（第 N 次），推出 xingchen 当白手套。在 angushushu 的"建议"下，xingchen 拿测试服开了二周目。说白了：用别人的手赌一把，赢了是我的功劳，输了是他的锅。',
  '弹劾风波 — xingchen 贪污了服务器全部捐款，被抓了个现行。说实话，在这个充满理想主义的地方搞贪污，格局小了。AdlambXD 和 Mark_Q 闪亮登场"救火"——早就等着这一天了。',
