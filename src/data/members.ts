...
export const adminTimeline: AdminTimelineEvent[] = [
  { description: 'Commune 社区时代 — SiYang 与 angushushu 共同点燃了最初的火种。' },
  { description: 'CubeX 开服 — SiYang、angushushu 与 AkariDream 携手，方块叉正式启航。' },
  { description: '首次裂痕 — SiYang 与 angushushu 产生矛盾后离开，angushushu 与 AkariDream 继续前行。' },
  { description: '第一次交接 — 2023 年 1 月，angushushu 尝试退休，AkariDream 推举 XY_Kuailexy 接手。但 AkariDream 扶持的试用管理 xmzh 乱封人，服务器陷入混乱。' },
  { description: '回归与决裂 — angushushu 重返服务器，与 AkariDream 矛盾激化，最终分道扬镳。' },
  { description: '小湖镇复兴 — angushushu 与小湖镇管理 wwwer 携手重建 CubeX，wwwer 因贡献被提拔为 OP。' },
  { description: '短暂重聚 — AkariDream 部分回归，与 angushushu、wwwer 再次共事。' },
  { description: '故人归来 — SiYang 回归，angushushu、wwwer 与 SiYang 三人共治。' },
  { description: '半退休时代 — 2024 年 1 月，angushushu 与 wwwer 半退休转为顾问，SiYang 独自撑起大局，同时开展测试服。' },
  { description: '预备交接 — SiYang 退休，AdlambXD 与 Mark_Q 作为预备服主准备接收。' },
  { description: 'xingchen 时期 — 2024 年 6 月，angushushu 等人正式退休，xingchen 接手管理。' },
  { description: '弹劾风波 — xingchen 因撒谎和贪污服务器全部捐款被弹劾，AdlambXD 与 Mark_Q 回归接管。' },
  { description: '实体机时代 — 多位服主凑钱购买实体机，安置于 Mark 家中。AdlambXD 主事。' },
  { description: '权力更迭 — 2025 年暑期，因 AdlambXD 过于保守，Mark_Q 联合 LCDJ 与 steve3184 取代其主事地位。' },
  { description: '停滞 — Mark_Q 掌控了实体机与 QQ 群，趋于保守甚至一度失联，CubeX 的发展陷入停滞。' },
];
